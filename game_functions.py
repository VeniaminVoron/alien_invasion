...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, 
        bullets):
    """Обробатывает нажатия клавиш и события мыши."""
...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship, 
    ...
    """Запускает новую играу при нажатии кнопки Play."""
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, 
    ...
    if len(aliens) == 0:
        # Уничножение пуль, повышение скорости и создание нового флота.
        bullets.empty()
...
def get_number_stars_x(ai_settings, star_width):
    ...
    available_star_x = ai_settings.screen_width - star_width
    number_stars_x = randint(0, available_star_x // (40 * star_width))
    return number_stars_x
    
def get_number_star_rows(ai_settings, star_height):
    """Определяет количество рядов звезд."""
    available_star_y = ai_settings.screen_height - 2 * star_height
    number_star_rows = randint(20, available_star_y // (5 * star_height))
